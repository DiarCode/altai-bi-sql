...
-- CreateEnum
CREATE TYPE "GRAPH_TYPE" AS ENUM ('BAR_CHART', 'LINE_CHART', 'PIE_CHART', 'SCATTER_PLOT', 'AREA_CHART', 'HISTOGRAM', 'BOX_PLOT', 'HEATMAP', 'GEOGRAPHIC_MAP', 'RADAR_CHART', 'BUBBLE_CHART', 'FUNNEL_CHART', 'TREE_MAP');
